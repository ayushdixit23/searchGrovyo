  ...
  return (
    <>
      <div>
        ...
        {isOpen && (
          <div
            className="fixed inset-0 z-40 bg-black  sm:opacity-50 backdrop-blur-2xl"
            onClick={onClose}
          ></div>
        )}
        ...
        >
          <div className="w-[330px] shadow-lg rounded-2xl p-3 sm:p-4 bg-white dark:bg-bluedark">
            <div className="py-2">
            ...
            <div className="flex w-full justify-center mt-3 gap-2 items-center">
              <button
                onClick={onClose}
                className="p-2 px-5 w-full rounded-md dark:bg-[#323d4e] bg-[#f3f3f3]"
              >
                Cancel
              </button>
              <button
